...
departure |  | Departure datetime of the `VehicleJourney` for this stop in Navitia. In case of a stop addition, the departure time is set to *horaireVoyageurDepart/dateHeure*.
...
arrival |  | Arrival datetime of the `VehicleJourney` for this stop in Navitia. In case of a stop addition, the arrival time is set to *horaireVoyageurArrivee/dateHeure*.

...
def check_db_ire_96231_normal():
    with app.app_context():
        ...
        assert db_trip_delayed.vj.get_start_timestamp() == datetime.datetime(2015, 9, 21, 15, 21, tzinfo=utc)
...
def check_db_ire_96231_trip_removal():
    with app.app_context():
        ...
        assert db_trip_removal.vj.get_start_timestamp() == datetime.datetime(2015, 9, 21, 15, 21, tzinfo=utc)
...
def check_db_ire_6114_trip_removal():
    with app.app_context():
        ...
        db_trip_removal = TripUpdate.find_by_dated_vj('trip:OCETGV-87686006-87751008-2:25768-2',
                                                      datetime.datetime(2015, 10, 6, 10, 37, tzinfo=utc))
        assert db_trip_removal

        assert db_trip_removal.vj.navitia_trip_id == 'trip:OCETGV-87686006-87751008-2:25768-2'
        assert db_trip_removal.vj.get_start_timestamp() == datetime.datetime(2015, 10, 6, 10, 37, tzinfo=utc)
        assert db_trip_removal.vj_id == db_trip_removal.vj.id
        assert db_trip_removal.status == 'delete'
...
def check_db_ire_JOHN_trip_removal():
    with app.app_context():
        ...
        db_trip1_removal = TripUpdate.find_by_dated_vj('trip:OCETGV-87686006-87751008-2:25768',
                                                       datetime.datetime(2015, 9, 21, 10, 37, tzinfo=utc))
        assert db_trip1_removal

        assert db_trip1_removal.vj.navitia_trip_id == 'trip:OCETGV-87686006-87751008-2:25768'
        assert db_trip1_removal.vj.get_start_timestamp() == datetime.datetime(2015, 9, 21, 10, 37, tzinfo=utc)
        ...
        assert db_trip2_removal.vj.get_start_timestamp() == datetime.datetime(2015, 9, 21, 15, 21, tzinfo=utc)
...
def test_ire_partial_removal(mock_rabbitmq):
    ...
    with app.app_context():
        ...
        assert db_trip_partial_removed.vj.get_start_timestamp() == datetime.datetime(2017, 3, 18, 13, 05, tzinfo=utc)

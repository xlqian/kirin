...
def upgrade():
    ...
    sa.PrimaryKeyConstraint('navitia_id')
    )
    op.create_table('real_time_update',
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('date', sa.DateTime(), nullable=False),
    sa.Column('vj', sa.Text(), nullable=False),
    sa.ForeignKeyConstraint(['vj'], ['vehicle_journey.navitia_id'], ),
    sa.PrimaryKeyConstraint('id')
    )
    op.create_table('modification',
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('real_time_update_id', sa.Integer(), nullable=True),
